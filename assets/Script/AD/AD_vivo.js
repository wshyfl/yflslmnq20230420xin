...
window.AD_vivo = {
    box_id: "",//盒子广告
    bannerID_TT: "31bcdf71f0d5437f989b535d41670e86",//banner普通
    videoID_TT: "ecf0ac48dc7f4db2b632daf2b298bcc2",//视频
    chaPing_TT: ["4389d2a4c9904233962e83944f0ab35a", "4389d2a4c9904233962e83944f0ab35a", "4389d2a4c9904233962e83944f0ab35a"],//原生插屏
    ...
    showBannerNormal() {
        ...
        AD_vivo.banner.show()
            ...
            .catch(err => {
                console.log('banner广告组件出现问题', JSON.stringify(err));
            })
    },
    /**隐藏banner */
    hideBanner() {
